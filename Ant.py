# -*- coding: utf-8 -*-
"""
Created on Sun Dec 10 21:12:10 2017
...
class Ant:
    ...
    def __calculate_pheromone(self):
#        self.pheromone = Ant.a / (self.distance - Ant.b)
        self.pheromone = 1 / self.distance
...
def random_ant(distances):
    l = list(range(len(distances)))
    random.shuffle(l)
    return Ant(l, distances)
